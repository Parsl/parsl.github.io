...
boilerplate `__name__ == "__main__"` test I discussed at the start of this post.
...
, all of the Python objects in memory and imported modules are duplicated in the new process.
...
multiple threads - although this has always been a problem, it is less aggressively reported.
